...
-(void)addOtherSubViewUIMethrod {
    ...
    self.firstLabel = [self createLabelFrame:CGRectMake((CGRectGetWidth(self.frame)/NUM - size.width)/NUM, 0, size.width, CGRectGetHeight(self.frame)) title:@"咨询列表" textColor:TEXT_COLOR_MAIN textAlignment:NSTextAlignmentCenter font:[UIFont systemFontOfSize:16]];
    [self addSubview:self.firstLabel];
    self.secondLabel = [self createLabelFrame:CGRectMake((CGRectGetWidth(self.frame)/NUM - size.width)/NUM+CGRectGetWidth(self.frame)/NUM, 0, size.width, CGRectGetHeight(self.frame)) title:@"主播信息" textColor:TEXT_COLOR_DETAIL textAlignment:NSTextAlignmentCenter font:[UIFont systemFontOfSize:16]];
...
//    self.forthLabel = [self createLabelFrame:CGRectMake((CGRectGetWidth(self.frame)/NUM- size.width)/NUM+ CGRectGetWidth(self.frame)*3/NUM, 0, size.width, CGRectGetHeight(self.frame)) title:@"已退款" textColor:TEXT_COLOR_DETAIL textAlignment:NSTextAlignmentCenter font:[UIFont systemFontOfSize:16]];
...
//        self.forthLabel.textColor = TEXT_COLOR_DETAIL;
    ...
    [UIView animateWithDuration:0.5f animations:^{
        weakSelf.smallLineView.frame = CGRectMake(((Screen_W - 24)/NUM - 10)/NUM +Screen_W /NUM*weakSelf.selectIndex, CGRectGetHeight(weakSelf.frame) -  3, 20, 3);
