...
@interface LiveOnByeViewController ()

@end

@implementation LiveOnByeViewController
...
//    [content addSubview:line];
    ...
    [knowA setTitle:@"取消" forState:UIControlStateNormal];
    ...
    [knowB setTitle:@"接受" forState:UIControlStateNormal];
    ...
    [knowB addTarget:self action:@selector(goLive) forControlEvents:UIControlEventTouchUpInside];
...
- (void)goLive{
    [self dismissViewControllerAnimated:NO completion:nil];
    [self.delegate LiveOnByeAlertBtnClicked:_string];
}
